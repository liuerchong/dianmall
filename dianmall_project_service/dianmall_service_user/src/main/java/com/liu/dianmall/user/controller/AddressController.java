...
import com.liu.dianmall.user.service.AddressService;
...
public class AddressController {
     ...
     * @return
     */
    @ApiOperation(value = "查询�?�?Address",notes = "查询�?Address有方法详�?",tags = {"AddressController"})
    @GetMapping
    public Result<List<Address>> findAll(){
        //调用AddressService实现查询�?�?Address
