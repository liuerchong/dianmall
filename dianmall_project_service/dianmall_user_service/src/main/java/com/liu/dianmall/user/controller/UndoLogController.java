...
import com.liu.dianmall.user.service.UndoLogService;
...
public class UndoLogController {
     ...
     * @return
     */
    @ApiOperation(value = "查询�?�?UndoLog",notes = "查询�?UndoLog有方法详�?",tags = {"UndoLogController"})
    @GetMapping
    public Result<List<UndoLog>> findAll(){
        //调用UndoLogService实现查询�?�?UndoLog
