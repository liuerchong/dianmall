package com.liu.dianmall.user.controller;
import com.liu.dianmall.user.pojo.OauthClientDetails;
import com.liu.dianmall.user.service.OauthClientDetailsService;
import com.github.pagehelper.PageInfo;
import com.liu.dianmall.common.basic.Result;
import com.liu.dianmall.common.basic.StatusCode;
...
public class OauthClientDetailsController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path", name = "page", value = "当前�?", required = true, dataType = "Integer"),
     ...
     * @return
     */
    @ApiOperation(value = "查询�?�?OauthClientDetails",notes = "查询�?OauthClientDetails有方法详�?",tags = {"OauthClientDetailsController"})
    @GetMapping
    public Result<List<OauthClientDetails>> findAll(){
        //调用OauthClientDetailsService实现查询�?�?OauthClientDetails
