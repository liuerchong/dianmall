...
import com.liu.dianmall.user.service.ProvincesService;
...
public class ProvincesController {
     ...
     * @return
     */
    @ApiOperation(value = "查询�?�?Provinces",notes = "查询�?Provinces有方法详�?",tags = {"ProvincesController"})
    @GetMapping
    public Result<List<Provinces>> findAll(){
        //调用ProvincesService实现查询�?�?Provinces
